...
export class MyRegistrationsController {
  constructor(private readonly auctionRegistrationService: AuctionRegistrationService) {}
  ...
  list(
    ...
    if (!carrierId) throw new UnauthorizedException('Authenticated carrier is required');
